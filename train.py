...
from nets.siamese_resnet import Siamese
# from nets.siamese_vgg import Siamese
# from nets.siamese_superpoint import Siamese
...
from utils.utils import (download_weights, get_lr_scheduler, load_dataset,
                         set_optimizer_lr, show_config)  # config：配置
